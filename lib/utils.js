...
// TODO: These need to be alphabatized!
...
commander
	...
	.option('--chat', 'Enables ChatGPT related API requests.')
	.option(
		'-d, --dalle <string>',
	...
	.option(
		'--name <string>',
		'The name of the chat bot you wish to use when using ChatGPT. Purely cosmetic in the terminal.',
		'Bot'
	)
	.option(
		'-p, --prompt <string>',
	...
	.option(
		'-r, --raw',
		'Will output the ENTIRE raw response object to the console. Does not work with beautify flag. Enabling raw response while streaming will result in very large ouput!',
		false
	)
